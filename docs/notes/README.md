...
| [aligned-crease-hinges.md](aligned-crease-hinges.md) | One physical hinge can join several graph segments or distinct material creases on touching layers; their angle signs follow their stationary faces, and a turn towards +z or −z is read from the paper that moves |
