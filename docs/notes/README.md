...
| [two-held-paper-layers.md](two-held-paper-layers.md) | One folded diamond bends as two distinct touching layers; exact grips expose a fine-mesh solver limit |
