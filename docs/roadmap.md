...
equilibrium. Next inspect 55–93 in the final saved 1/64 refusal, without new
solves; the passing 1/128 and its start provide the controls.
...
1. **One checked flap rotation**, a bounded part of
   ...
   **Next: inspect 55–93 in the last saved 1/64 refusal, alongside its start and
   passing 1/128, without new solves.**
