...
geometry/cost checks unchanged. Next test up to ten material corrections with
at most one restoration per trial, keeping failures and the equilibrium test.
...
1. **One checked flap rotation**, a bounded part of
   ...
   **Next: up to ten material corrections, with at most one plane restoration
   per trial before halving, preserving all guards, actual checks and refusals.**
