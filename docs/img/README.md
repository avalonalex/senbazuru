...
```bash
stack run -- render examples/crane.fold                                   -o docs/img/crane-pattern.svg
stack run -- render examples/crane.fold --fold                            -o docs/img/crane-folded.svg
...
| File | What it shows |
| --- | --- |
| `crane-pattern.svg` | The traditional crane as its file stores it: a crease pattern, in the Yoshizawa–Randlett line notation |
| `crane-folded.svg` | The same file folded and drawn — 72 faces stacked, hidden edges gone |
