...
module FlapExample (singleFlap, opposingFlap, touchingFlap, blockedStack) where
...
-- | The opposing-flap control with a fourth, narrow panel already folded onto
...
blockedStack =
  emptyFrame
    { verticesCoords = [[0, 0], [0.3, 0], [0.7, 0], [1, 0], [1.2, 0], [1.2, 1], [1, 1], [0.7, 1], [0.3, 1], [0, 1]],
