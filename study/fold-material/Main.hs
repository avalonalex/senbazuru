...
import UnequalCreaseGallery (writeBandContact, writeBandLength, writeBandRefinement, writeBandRefinement8, writeBandRefinement8x2, writeCombinedBandRefinement, writeCombinedRefinement, writeFineCrease, writeUnequalCrease, writeUnequalRefinement)
